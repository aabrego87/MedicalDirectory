<?php
    ...
    class mainModel{
        ...
        /*----------------Function generar codigos aleatorios----------------------*/
        ...
        /*----------------Function validar imagen Registro----------------------*/
        protected static function validar_imagen($imagen){
            $checkImagen = @getimagesize($imagen); //Comprueba si la imagen es válida
            if ($checkImagen) {
                return false;
            } else {
                return true;
