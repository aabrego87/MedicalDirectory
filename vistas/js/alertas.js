...
function enviar_formulario_ajax(e){
    ...
    if(tipo==="save"){
        ...
        texto_alerta="Se eliminará el término de busqueda y tendrás que escribir uno de nuevo";
    }else if (tipo==="loans"){
        texto_alerta="Desea remover los datos seleccionados";
    }else if(tipo==="start"){
        texto_alerta="La consulta dará inicio en el momento en que presione el botón de Aceptar";
    }else{
