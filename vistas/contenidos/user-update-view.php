...
<?php
    ...
    $datos_usuario = $ins_usuario->datos_usuario_conrolador("Unico", $pagina[1]);
    if($datos_usuario->rowCount() == 1){
        $campo = $datos_usuario->fetch();
?>
                ...
                <div class="row">
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,35}" class="form-control" name="usuario_nombre_up" value="<?php echo $campo['usuario_nombre']; ?>" id="usuario_nombre" maxlength="35">
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            <label for="usuario_apellido" class="bmd-label-floating">Apellido paterno</label>
                            <input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,35}" class="form-control" name="usuario_apellido_p_up" value="<?php echo $campo['usuario_apellido_p']; ?>" id="usuario_apellido_p" maxlength="35">
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            <label for="usuario_apellido" class="bmd-label-floating">Apellido Materno</label>
                            <input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,35}" class="form-control" name="usuario_apellido_m_up" value="<?php echo $campo['usuario_apellido_m']; ?>" id="usuario_apellido_m" maxlength="35">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="usuario_telefono" class="bmd-label-floating">Teléfono</label>
                            <input type="text" pattern="[0-9()+]{8,20}" class="form-control" name="usuario_telefono_up" value="<?php echo $campo['usuario_telefono']; ?>" id="usuario_telefono" maxlength="20">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="usuario_direccion" class="bmd-label-floating">Dirección</label>
                            <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,190}" class="form-control" name="usuario_direccion_up" value="<?php echo $campo['usuario_direccion']; ?>" id="usuario_direccion" maxlength="190">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" pattern="[a-zA-Z0-9]{1,35}" class="form-control" name="usuario_usuario_up" value="<?php echo $campo['usuario_usuario']; ?>" id="usuario_usuario" maxlength="35">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="usuario_email" class="bmd-label-floating">Email</label>
                            <input type="email" class="form-control" name="usuario_email_up" value="<?php echo $campo['usuario_email']; ?>" id="usuario_email" maxlength="70">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="usuario_estado_up">
                                <option value="Activa" <?php if($campo['usuario_estado'] == 'Activa'){
                                    echo "selected";} ?>>Activa</option>
                                <option value="Deshabilitada" <?php if($campo['usuario_estado'] == 'Deshabilitada'){
                    ...
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            <select class="form-control" name="usuario_privilegio_up">
                                ...
                                <option value="1" <?php if($campo['usuario_privilegio'] == '1'){
                                    echo "selected";
                                }?>>Control total</option>
                                <option value="2" <?php if($campo['usuario_privilegio'] == '2'){
                                    echo "selected";
                                }?>>Edición</option>
                                <option value="3" <?php if($campo['usuario_privilegio'] == '3'){
                                    echo "selected";
                                }?>>Registrar</option>
                            </select>
                        </div>
