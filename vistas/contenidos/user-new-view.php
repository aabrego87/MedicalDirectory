<?php  
    if ($_SESSION['privilegio_mdirectory']!=1 && $_SESSION['privilegio_mdirectory']!=3) {
...
<!-- Content -->
<div class="container-fluid">
    <form class="form-neon FormularioAjax" action="<?php echo SERVERURL; ?>ajax/usuarioAjax.php"  method="POST" data-form="save" autocomplete="off" enctype="multipart/form-data">
        <fieldset>
                ...
                <div class="row">
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            <label for="usuario_nombre" class="bmd-label-floating">Nombre (s)</label>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            <label for="usuario_apellido_p_" class="bmd-label-floating">Apellido Paterno</label>
                            <input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,35}" class="form-control" name="usuario_apellido_p_reg" id="usuario_apellido" maxlength="35" required="">
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            <label for="usuario_apellido_m_" class="bmd-label-floating">Apellido Materno</label>
                            <input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,35}" class="form-control" name="usuario_apellido_m_reg" id="usuario_apellido" maxlength="35" required="">
                        </div>
                    </div>
        ...
        <fieldset>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="usuario_imagen_reg" class="bmd-label-floating">Foto de Perfil</label>
                            <input type="file" class="form-control" name="usuario_imagen_reg" id="usuario_imagen_reg">
                        </div>
                    </div>
                </div>
            </div>
