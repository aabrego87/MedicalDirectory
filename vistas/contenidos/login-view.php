<!-- <header>
    <video onloadedmetadata="this.muted=true" autoplay loop muted>
        <source src="<?php echo SERVERURL; ?>vistas/assets/video/video.mp4">
    </video>
...
<div class="login-container">
    <div class="login-content">
        <p class="text-center">
            <img src="<?php echo SERVERURL; ?>vistas/assets/logo/Logo.png" alt="Logo Medical Directory">
        </p>
        <p class="text-center">
        ...
        <form action="" method="POST" autocomplete="off" >
            ...
            <a href="<?php echo SERVERURL; ?>register-type" class="reg-login">REGÍSTRATE</a>
        </form>
    </div>
</div>
